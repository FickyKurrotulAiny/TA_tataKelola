...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form class="main-form" action="{{ route('persediaan.update', $persediaan->id) }}" method="POST"
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="volumeBarang_saldo" placeholder="Volume Barang (Saldo Awal)"
                        class="form-control" value="{{ old('volumeBarang_saldo', $persediaan->volumeBarang_saldo) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Volume Barang (Masuk)</label>
                    <input type="text" name="volumeBarang_masuk" placeholder="Volume Barang (Masuk)" class="form-control"
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="volumeBarang_keluar" placeholder="Volume Barang (Keluar)"
                        class="form-control" value="{{ old('volumeBarang_keluar', $persediaan->volumeBarang_keluar) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Volume Barang (Sisa)</label>
                    <input type="text" name="volumeBarang_sisa" placeholder="Volume Barang (Sisa)" class="form-control"
