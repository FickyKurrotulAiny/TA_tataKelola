...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form class="main-form row" action="{{ route('inventaris.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- @method('PUT') -->
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="nilai_barang" placeholder="Nilai Barang"
                        class="form-control @error('nilai_barang') is-invalid @enderror" value="{{ old('nilai_barang') }}">
                    @error('nilai_barang')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="kondisi_baru" placeholder="Kondisi (B)"
                        class="form-control @error('kondisi_baru') is-invalid @enderror" value="{{ old('kondisi_baru') }}">
                    @error('kondisi_baru')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
