        ...
        <div class="card-body">
            <form class="main-form row" action="{{ route('inventaris.update', $inventaris->id) }}" method="POST"
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="kondisi_rusakRingan" placeholder="Kondisi (RR)" class="form-control"
                        value="{{ old('kondisi_rusakRingan', $inventaris->kondisi_rusakRingan) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Kondidsi (RB)</label>
                    <input type="text" name="kondisi_rusakBerat" placeholder="Kondidsi (RB)" class="form-control"
                        value="{{ old('kondisi_rusakBerat', $inventaris->kondisi_rusakBerat) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Kondisi (Hilang)</label>
                    <input type="text" name="kondisi_hilang" placeholder="Kondisi (Hilang)" class="form-control"
                        value="{{ old('kondisi_hilang', $inventaris->kondisi_hilang) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Pelebelan (S)</label>
                    <input type="text" name="pelebelan_sudah" placeholder="Pelebelan (S)" class="form-control"
                        value="{{ old('pelebelan_sudah', $inventaris->pelebelan_sudah) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Pelebelan (B)</label>
                    <input type="text" name="pelebelan_belum" placeholder="Pelebelan (B)" class="form-control"
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="namapengguna_unit" placeholder="Nama Pengguna (Unit)"
                        class="form-control" value="{{ old('namapengguna_unit', $inventaris->namapengguna_unit) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="nama_ruangan" placeholder="Nama Ruangan" class="form-control"
                        value="{{ old('nama_ruangan', $inventaris->nama_ruangan) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
