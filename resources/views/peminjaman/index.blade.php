            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card" style="width: 100%;">
                    <div class="card-header">
                        <a href="{{route('peminjaman.create')}}" class="btn btn-primary"><i class="fas fa-plus-square"></i>&nbsp;&nbsp;&nbsp;Tambah</a>
                    </div>
                    <div class="card-body">
                        <!-- <div class="table-responsive"> -->
                            <table class="table table-bordered table-md" id="peminjaman">
                                <thead>
                                    <tr>
                                        <th width="3%">No</th>
                                        <th>Tanggal</th>
...
<script>
    ...
    function deletePeminjaman(id){
        swal({
                title: "Yakin ?",
                text: "Anda akan menghapusnya peminjaman",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
