...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form class="main-form row" action="{{ route('pinjam.update', $peminjaman->id) }}" method="POST"
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="tahun_peroleh" placeholder="Tahun Peroleh"
                        class="form-control"value="{{ old('tahun_peroleh', $peminjaman->tahun_peroleh) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                    <label for="" class="form-label">Jumlah Barang</label>
                    <input type="text" name="jumlah" placeholder="Jumlah Barang"
                        class="form-control"value="{{ old('jumlah', $peminjaman->jumlah) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="jjurusan" placeholder="Jurusan"
                        class="form-control"value="{{ old('jjurusan', $peminjaman->jjurusan) }}">
                </div>
                <div class="mb-3 col-md-6 col-xl-4">
                ...
                <div class="mb-3 col-md-6 col-xl-4">
                    ...
                    <input type="text" name="nama_dosen" placeholder="Nama Dosen"
                        class="form-control"value="{{ old('nama_dosen', $peminjaman->nama_dosen) }}">
                </div>
