        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <form class="main-form" action="{{ route('pinjam.update', $pinjam->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6 col-xl-4">
                                    ...
                                    <input type="date" name="tanggal_kembali" placeholder="Rencana Kembali Tanggal"
                                        ...
                                        value="{{ $pinjam ? $pinjam->tanggal_kembali : old('tanggal_kembali') }}">
                                ...
                                <div class="mb-3 col-md-6 col-xl-4">
                                    ...
                                    <input type="text" name="jurusan" placeholder="Jurusan"
                                        ...
                                        value="{{ $pinjam ? $pinjam->jurusan : old('jurusan') }}">
                                    @error('jurusan')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-6 col-xl-4">
                                    ...
                                    <input type="text" name="program_studi" placeholder="Program Studi"
                                        ...
                                        value="{{ $pinjam ? $pinjam->program_studi : old('program_studi') }}">
                                    @error('program_studi')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-6 col-xl-4">
                                    ...
                                    <input type="text" name="nama_dosen" placeholder="Nama Dosen"
                                        ...
                                        value="{{ $pinjam ? $pinjam->nama_dosen : old('nama_dosen') }}">
                                    @error('nama_dosen')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="6" placeholder="Keterangan" name="keterangan"
                                        class="form-control @error('keterangan') is-invalid @enderror">{{ $pinjam ? $pinjam->keterangan : old('keterangan') }}</textarea>
                                    @error('keterangan')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
